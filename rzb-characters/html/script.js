    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
					setCharactersList()
                    $.post('https://rzb-characters/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('https://rzb-characters/removeBlur');
                    }, 2000);
                }, 2000);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://rzb-characters/closeUI');
    $.post('https://rzb-characters/disconnectButton');
});
...
function setupCharacters(characters) {
    $.each(characters, function(index, char){
        ...
        setTimeout(function(){
            $('#char-'+char.cid).html('<span id="l-name"><span id="info-label"></span>'+char.charinfo.firstname+' '+char.charinfo.lastname+'<span id="cid"><span id="info-label">Job: </span>' + char.job.label + '</span><span id="job"><span id="info-label">Phone Number: </span>' + char.charinfo.phone + '</span><span id="phone"><span id="info-label">Cash: </span>' +dollar.format(char.money.cash)+ '</span><span id="phone2"><span id="info-label">Bank: </span>' +dollar.format(char.money.bank)+ '</span>');
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('https://rzb-characters/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://rzb-characters/createNewCharacter', JSON.stringify({
        firstname: firstname,
        lastname: lastname,
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://rzb-characters/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://rzb-characters/selectCharacter', JSON.stringify({
